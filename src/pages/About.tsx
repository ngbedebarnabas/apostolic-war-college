    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="section-padding bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">About Adullam & AC</h2>
          <div className="glass p-8 rounded-lg">
            ...
            <p className="mb-6 text-lg">
              As part of our specialized training modules, we introduce the Apostolic College (AC)—a strategic training platform designed to equip the saints for End-time Spiritual Warfare and Kingdom advancement across every sphere of society. AC serves as an intensive training module where believers are immersed in the knowledge, discipline, and spiritual strategies required to contend for the faith and establish God's will in their respective domains.
            </p>
